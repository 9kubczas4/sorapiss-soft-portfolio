...
const routes: Routes = [
  {
    ...
    data: {
      pages: [
        { label: 'Abstract Multi Step Form', url: 'use-cases/abstract-multi-step-form/contact', icon: 'library_books' },
        { label: 'Advanced Dependency Injection', url: 'use-cases/advanced-dependency-injection', icon: 'jump_to_element' },
        { label: 'Advanced Directives', url: 'use-cases/advanced-directives', icon: 'switch_access_shortcut_add' },
        { label: 'Component Factory Directive', url: 'use-cases/component-factory-directive', icon: 'settings_applications' },
        { label: 'Enhance Material Components', url: 'use-cases/enhance-material', icon: 'switch_access_shortcut_add' },
        { label: 'Generic Layout', url: 'use-cases/generic-layout', icon: 'view_column' },
        { label: 'User Permissions', url: 'use-cases/user-permissions', icon: 'person_outline' },
      ],
    },
  },
];
