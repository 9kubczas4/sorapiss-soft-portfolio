...
* [Course - Angular for Beginners Course](https://www.youtube.com/watch?v=3qBXWUpoPHo) by [GDE Santosh Yadav]()
  * Almost 18 hours of course.
  * Angular 13
* [Course - Angular Tutorial for Beginners](https://www.youtube.com/watch?v=k5E2AVpwsko) by [Programming with Mosh]()
  * Well structured knowledge, created in 2017, but most of the information's are still up to date.
  * Angular 4

## Angular CLI
  * [V - The Basics](https://www.youtube.com/watch?v=IZEolKjcjks) by [Fireship]
...
* [V - Angular Router Authentication and Authorization Real LIVE LIVE LIVE LIVE LIVE Demo - Shai Reznik](https://www.youtube.com/watch?v=yjxOYsRkozQ) by [GDE Shai Reznik]()
...
* [V - RxJS Crash Course](https://www.youtube.com/watch?v=tGWBy6Vqq9w) by [Laith Academy]()
* [V - 3 Levels of Learning RxJS Operators](https://www.youtube.com/watch?v=4laSr0wjAvw) by [GDE Joshua Morony]()
* [V - Thinking Reactively: Most Difficult | Mike Pearson](https://www.youtube.com/watch?v=-4cwkHNguXE) by [Mike Pearson]()

#### RxJs Operators
* [V - I only ever use *these* RxJS operators to code reactively](https://www.youtube.com/watch?v=Byttv3YpjQk) by [GDE Joshua Morony]()
* [V - 20 RXJS Operators in 20 minutes | Mike Brocchi & John Niedzwiecki](https://www.youtube.com/watch?v=ak3MvMn8u18) by [Mike Brocchi & John Niedzwiecki]()
* [V - I switched a map and you'll never guess what happened next - Pete Darwin, Shai Reznik, Mike Brocchi](https://www.youtube.com/watch?v=rUZ9CjcaCEw) by [Pete Darwin](), [GDE Shai Reznik]() and [Mike Brocchi]()
* [V - RxJs Operators - ExhaustMap vs concatMap (2021)](https://www.youtube.com/watch?v=nh13_aPRQ0Q) by [GDE Dmytro Mezhenskyi]()
* [V - RxJs switchMap vs mergeMap - Intro to Flattening Operators (2021)](https://www.youtube.com/watch?v=qYdKmYp95Jg) by [GDE Dmytro Mezhenskyi]()
* [V - RxJs Zip - Real-Life Analog of ZIP operator (Reactive Dürüm, 2021)](https://www.youtube.com/watch?v=csRIMubWYnw) by [GDE Dmytro Mezhenskyi]()
* [V - RxJs Schedulers - Why do we need them? (Advanced, 2021)](https://www.youtube.com/watch?v=-OhAR6l-Q0Q) by [GDE Dmytro Mezhenskyi]()

#### RxJs Hot vs Cold
* [V - How to share your RxJS observables for improved performance](https://www.youtube.com/watch?v=H542ZSyubrE) by [GDE Joshua Morony]()
* [V - Hot vs Cold Observable in RxJs (2021)](https://www.youtube.com/watch?v=oKqcL-iMITY) by [GDE Dmytro Mezhenskyi]()
* [V - ]() by []()

#### RxJS Best Practices
* [V - RxJS Advanced Patterns – Operate Heavily Dynamic UI’s | Michael Hladky](https://www.youtube.com/watch?v=XKfhGntZROQ) by [GDE Michael Hladky]()
* [V - RxJS Best Practices Aren't Always Black and White | Deborah Kurata | ng-conf 2022](https://www.youtube.com/watch?v=rQTSMbeqv7I) by [GDE Deborah Kurata]()
* [V - Reactive patterns for Angular Enterprise Solutions - Brecht Billiet - NG-BE 2023](https://www.youtube.com/watch?v=58h_w7PzNtM) by [Brecht Billiet]()

#### RxJS Testing
* [V - Marble testing with RxJS testing utils](https://www.youtube.com/watch?v=rlkCeeyBwf8) by [GDE Kevin Kreuzer]()
* [V - Is reactive code with RxJS too hard to test?](https://www.youtube.com/watch?v=z12fxor21gA) by [GDE Joshua Morony]()
...
* [V - WTF is "Zone.js" and is it making your app slow?](https://www.youtube.com/watch?v=lmrf_gPIOZU) by [GDE Joshua Morony]()
