...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'context-menu',
        loadChildren: () =>
          import(`./pages/sample-context-menu/sample-context-menu.module`).then(c => c.SampleContextMenuModule),
      },
      {
      ...
      },
      {
        path: 'slideout',
        loadChildren: () =>
          import(`./pages/sample-slideout/sample-slideout.module`).then(m => m.SampleSlideoutModule),
      },
    ],
    data: {
      pages: [
        { label: 'Context Menu', url: 'ui/context-menu', icon: 'menu' },
        { label: 'Disable Interactive Elements', url: 'ui/disabled-interactive-elements', icon: 'block' },
